            ...
            <main class="main">
                ...
                <div class="section">
                    <?php
                        ...
                        $paisesCiudades = array(
                            "España" => array("Madrid", "Barcelona", "Valencia"),
                            "Francia" => array("París", "Marsella", "Lyon"),
                            "Cuba" => array("La Habana", "Cienfuegos", "Santiago de Cuba"),
                            "Italia" => array("Roma", "Milán", "Venecia"),
                            "Reino Unido" => array("Londres", "Manchester", "Glasgow")
                        );

                        // Step 2: Loop and display the multidimensional array
                        foreach ($paisesCiudades as $pais => $ciudades) {

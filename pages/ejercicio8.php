    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <main class="main">
                ...
                <div class="section">
                    <?php
                        // Create an array called $numbers that contains 10 random integers in the range 1 to 100.
                        $numeros = array();
                        for ($i = 0; $i < 10; $i++) {
                            $numeroAleatorio = rand(1, 100);
                            $numeros[] = $numeroAleatorio;
                        }
                        // Initialize variables for odd and even sums.
                        $sumaPares = 0;
                        $sumaImpares = 0;

                        // Calculate the sum of the even and odd numbers in the array $numeros.
                        foreach ($numeros as $numero) {
                            if ($numero % 2 == 0) {
                                // If it is even, add it to the sum of evens.
                                $sumaPares += $numero;
                            } else {
                        ...
                        // We show the entire formatted array
                        echo "Números generados aleatoriamente: ".implode(", ",$numeros);

                    ?>
                    <!-- We create a table to show the sum of even and odd numbers -->
                    <table class="table">
                      <tr>
                        <th>TIPO</th>
                        <th>SUMA</th>                       
